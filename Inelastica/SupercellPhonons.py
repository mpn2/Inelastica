...
def GetOptions(argv,**kwargs):
    ...
    p.add_argument('-f','--fudge',dest='accuracy',type=float,default=1e-4,
                   help='Ignore asymmetries smaller than this. [default=%(default)s]')
